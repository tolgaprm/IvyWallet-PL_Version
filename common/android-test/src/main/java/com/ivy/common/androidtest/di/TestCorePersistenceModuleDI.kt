...
object TestCorePersistenceModuleDI {
    ...
    @Provides
    @Singleton
    fun provideAccountCacheDao(db: IvyWalletCoreDb): AccountCacheDao =
        db.accountCacheDao()

    @Provides
    @Singleton
    fun provideAccountFolderDao(db: IvyWalletCoreDb): AccountFolderDao =
        db.accountFolderDao()
    ...
    @Provides
    @Singleton
    fun provideExchangeRateDao(db: IvyWalletCoreDb): ExchangeRateDao =
        db.exchangeRateDao()
    ...
    @Provides
    @Singleton
    fun provideTrnLinkRecordDao(db: IvyWalletCoreDb): TrnLinkRecordDao =
        db.trnLinkRecordDao()
